...
function CategoryItem({ navigation, route }) {
  return (
              ...
              <View style={styles.ImageContainer} key={item.id}>
                ...
                <View style={styles.textContainer}>
                  <TouchableOpacity
                    style={styles.info}
                    onPress={() =>
                      navigation.navigate("productfulldetail", {
                        itemId: 86,
                  ...
                  >
                    ...
                    <Text style={styles.TitleText1}>{item.variant}</Text>
                  </TouchableOpacity>
                  ...
                  <View>
                    <Text style={styles.AdditionalText}>{item.info}</Text>
                  </View>
                </View>
              </View>
            </>
